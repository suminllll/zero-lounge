...
export default function AdminPage() {
  ...
  return (
    <div className="min-h-screen bg-black flex justify-center">
      <main
        className="w-full max-w-[390px] min-h-screen bg-[#1a1210] text-[#f5e2d4] relative"
      ...
      >
        ...
        {/* 하단 탭 바 */}
        <div
          className="absolute bottom-0 left-0 right-0 bg-[#1a1210] border-t border-[#2a2220] flex z-20"
